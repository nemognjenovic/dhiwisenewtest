  ...
  return (
    <>
      <div className="bg-gray_100 flex font-inter mx-[auto] relative w-[100%]">
        ...
        <div
          className="bg-cover bg-no-repeat flex h-[1024px] items-center justify-start ml-[-45px] my-[auto] p-[100px] md:px-[20px] w-[46%] z-[1]"
          style={{ backgroundImage: "url('images/img_main.svg')" }}
        >
          <div className="flex flex-col items-start justify-start mb-[4px] md:w-[100%] w-[78%]">
            <Img
              src="images/img_question.svg"
              className="h-[41px] w-[41px]"
              alt="question"
            />
            <div className="flex flex-col gap-[14px] items-start justify-start mt-[49px] md:w-[100%] w-[auto]">
              <Text
            ...
            <div className="flex flex-col gap-[30px] items-center justify-start mt-[60px] w-[100%]">
            ...
            <Text
              className="font-normal md:ml-[0] ml-[232px] mt-[23px] not-italic text-indigo_A200 text-left w-[auto]"
              as="h4"
              variant="h4"
            >
              Forgot Password?
            </Text>
            <Button className="bg-indigo_A200 cursor-pointer font-normal min-w-[350px] mt-[31px] not-italic py-[20px] rounded-[29px] text-[14px] text-center text-white_A700 w-[auto]">
              Login
            </Button>
